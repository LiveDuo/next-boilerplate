...
const Section = () => (
  <Box margin="40px 60px 20px 60px">
    ...
    <Text>
      ...
      <strong>you</strong>), and <strong>{company}</strong>, doing business as
      <strong> {company}</strong> <strong>({url}) </strong>website as well as
      any related applications (the <strong>Site</strong>). &nbsp;
    </Text>
    <Text>
      The Site provides the following services: (<strong>Services</strong>). You
    ...
    <Text>
      ...
      version will be effective as soon as it is accessible. You are responsible
      for reviewing these Terms and Conditions to stay informed of updates. Your
    ...
    <Text>
      1.5 Our site is directed to people residing in England. The information
    ...
    <Text>
      ...
      {url}/privacy, which sets out the terms on which we process any personal
      data we collect from you, or that you provide to us. By using the Site,
      you consent to such processing and you warrant that all data provided by
      you is accurate. &nbsp;
    </Text>
    <Text>
      <strong>&mdash; </strong>Our Acceptable Use Policy {email}, which sets out
      the permitted uses and prohibited uses of the Site. When using the Site,
      you must comply with this Acceptable Use Policy. &nbsp;
    </Text>
    <Text>
      <strong>&mdash; </strong>Our Cookie Policy {url}, which sets out
    ...
    <br />
    <Text>
      2.1 Our full Acceptable Use Policy {email}, sets out all the permitted
      uses and prohibited uses of this site. &nbsp;
    </Text>
    <Text>
      2.2 You may not access or use the Site for any purpose other than that for
    ...
    <Text>2.3 As a user of this Site, you agree not to: &nbsp;</Text>
    <Text>
      <strong>&mdash; </strong>Falsely imply a relationship with us or another
      company with whom you do not have a relationship{" "}
    </Text>
    <br />
    ...
    <Text>
      ...
      you must promptly notify us at {email}.
    </Text>
    <Text>
    ...
    <Text>
      ...
      feedback to us (<strong>User Content</strong>). You understand and agree
    ...
    <Text>
      ...
      in our opinion, such User Content does not comply with the Acceptable Use
      Policy. &nbsp;
    </Text>
    <Text>
      ...
      Content has not been verified or approved by us and the views expressed by
      other users on the Site do not represent our views or values
    </Text>
    <Text>
      4.7 If you wish to complain about User Content uploaded by other users
      please contact us at {email} or use the take down or report button.
      &nbsp;&nbsp;&nbsp;
    </Text>
    <br />
    ...
    <Text>
      ...
      text, photographs, and graphics on the Site (<strong>Our Content</strong>)
    ...
    <Text>
      ...
      not us, is responsible for such goods and/or services and if you have any
    ...
    <Text>
      ...
      completeness of the Site&acirc;&euro;&trade;s content and are not liable
      for any (1) errors or omissions in content: (2) any unauthorized access to
      ...
      cessation of transmission to or from the site or services; and/or (4) any
    ...
    <Text>9.2 Our responsibility for loss or damage suffered by you:</Text>
    <Text>
    ...
    <Text>
      <strong>&mdash; </strong>use of, or inability to use, our Site/Services;
      or{" "}
    </Text>
    <Text>
      <strong>&mdash; </strong>use of or reliance on any content displayed on
      our Site.{" "}
    </Text>
    <Text>In particular, we will not be liable for:</Text>
    <Text>
    ...
    <Text>
      ...
      or business purposes, and we have no liability to you for any loss of
    ...
    <Text>
      ...
      caused by our failure to use reasonable care and skill, we will either
      repair the damage or pay you compensation.{" "}
    </Text>
    <Text>
      <strong>&mdash; </strong>You have legal rights in relation to goods that
    ...
    <Text>
      ...
      while you use the Site or Services or are otherwise a user of the Site, as
    ...
    <Text>
      ...
      <em>
        ...
        of Scotland, you may also bring proceedings in Scotland. If you have any
    ...
    <Text>
      ...
      <em>
        ...
        are governed by English Law. We both agree to the exclusive jurisdiction
